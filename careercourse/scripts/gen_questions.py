"""Career stage quiz questions for user assessment."""
QUESTIONS = [
    # 1. Education & Skills
    {
        "id": 1,
        "category": "education",
        "question": "What is your current education/skills situation?",
        "options": [
    ...
    # 5. Network
    {
        "id": 5,
        "category": "network",
        "question": "How's your professional network?",
        "options": [
    ...
    # 7. Mentorship
    {
        "id": 7,
        "category": "mentorship",
        "question": "Do you have access to mentors?",
        "options": [
    ...
    # 8. Time availability
    {
        "id": 8,
        "category": "time",
        "question": "How much time can you dedicate to your goal?",
        "options": [
    ...
    # 10. Failure experience
    {
        "id": 10,
        "category": "failure",
        "question": "How have you handled past failures?",
        "options": [
    ...
    # 15. Geographic ambition
    {
        "id": 15,
        "category": "geography",
        "question": "Where do you want to build your career?",
        "options": [
    ...
    # 18. Time pressure
    {
        "id": 18,
        "category": "pressure",
        "question": "How much time pressure do you feel?",
        "options": [
    ...
    # 19. Role model type
    {
        "id": 19,
        "category": "rolemodel",
        "question": "Which type of success inspires you?",
        "options": [
